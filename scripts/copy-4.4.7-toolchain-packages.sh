...
cp -f ../opt-mingw-binutils2.19/opt-mingw-i686-binutils-git-2.19+r59477.c0.g5cecc4f11e88-1-any.pkg.tar.zst ./gcc4.4.7_toolchain_mingw_32_packages/
...
cp -f ../opt-mingw-zlib/opt-mingw-i686-zlib-1.2.13-3-any.pkg.tar.zst ./gcc4.4.7_toolchain_mingw_32_packages/
