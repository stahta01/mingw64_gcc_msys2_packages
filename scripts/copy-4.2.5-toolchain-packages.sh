...
cp -f ../opt-mingw-crt2.0.6/opt-mingw-i686-headers-git-2.0.6.2656.06c5a4241b47-2-any.pkg.tar.zst ./gcc4.2.5_toolchain_mingw_32_packages/
cp -f ../opt-mingw-crt2.0.6/opt-mingw-i686-crt-git-2.0.6.2656.06c5a4241b47-2-any.pkg.tar.zst ./gcc4.2.5_toolchain_mingw_32_packages/
