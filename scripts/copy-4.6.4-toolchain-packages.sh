...
cp -f ../opt-mingw-crt2.0.8/opt-mingw-i686-headers-git-2.0.8.2684.696f2831b313-4-any.pkg.tar.zst ./gcc4.6.4_toolchain_mingw_32_packages/
cp -f ../opt-mingw-crt2.0.8/opt-mingw-i686-crt-git-2.0.8.2684.696f2831b313-4-any.pkg.tar.zst ./gcc4.6.4_toolchain_mingw_32_packages/
cp -f ../opt-mingw-binutils2.24/opt-mingw-i686-binutils-git-2.24+r78634.c2.gcd3813a8c9e5-2-any.pkg.tar.zst ./gcc4.6.4_toolchain_mingw_32_packages/
