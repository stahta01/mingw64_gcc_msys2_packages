...
cp -f ../opt-mingw-crt6/opt-mingw-x86_64-headers-git-6.0.0.5241.e174bf62d33d-3-any.pkg.tar.zst ./gcc4.6.4_toolchain_mingw_64_packages/
cp -f ../opt-mingw-crt6/opt-mingw-x86_64-crt-git-6.0.0.5241.e174bf62d33d-3-any.pkg.tar.zst ./gcc4.6.4_toolchain_mingw_64_packages/
cp -f ../opt-mingw-crt6/opt-mingw-x86_64-pthread-stub-headers-git-6.0.0.5241.e174bf62d33d-3-any.pkg.tar.zst ./gcc4.6.4_toolchain_mingw_64_packages/
