...
cp -f ../opt-mingw-zlib/opt-mingw-x86_64-zlib-1.2.13-1-any.pkg.tar.zst ./support_mingw_64_packages/
...
cp -f ../opt-mingw-zlib/opt-mingw-i686-zlib-1.2.13-1-any.pkg.tar.zst ./support_mingw_32_packages/
