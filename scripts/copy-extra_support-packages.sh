...
cp -f ../opt-mingw-pkgconf/opt-mingw-x86_64-pkgconf-1.9.3-3-any.pkg.tar.zst ./extra_support_mingw_64_packages/
...
cp -f ../opt-mingw-pkgconf/opt-mingw-i686-pkgconf-1.9.3-3-any.pkg.tar.zst ./extra_support_mingw_32_packages/
