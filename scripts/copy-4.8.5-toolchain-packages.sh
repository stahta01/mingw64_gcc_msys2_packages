...
cp -f ../opt-mingw-gcc4.8/opt-mingw-i686-gcc-libs-git-4.8.5+d20150623.r51.c11.g2a62b047eca5-2-any.pkg.tar.zst ./gcc4.8.5_toolchain_mingw_32_packages/
cp -f ../opt-mingw-gcc4.8/opt-mingw-i686-gcc-git-4.8.5+d20150623.r51.c11.g2a62b047eca5-2-any.pkg.tar.zst ./gcc4.8.5_toolchain_mingw_32_packages/
cp -f ../opt-mingw-gcc4.8/opt-mingw-i686-gcc-ada-git-4.8.5+d20150623.r51.c11.g2a62b047eca5-2-any.pkg.tar.zst ./gcc4.8.5_toolchain_mingw_32_packages/
