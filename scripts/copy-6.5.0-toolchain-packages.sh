...
cp -f ../opt-mingw-zlib/opt-mingw-x86_64-zlib-1.2.13-2-any.pkg.tar.zst ./gcc6.5.0_toolchain_mingw_64_packages/
...
cp -f ../opt-mingw-zlib/opt-mingw-i686-zlib-1.2.13-2-any.pkg.tar.zst ./gcc6.5.0_toolchain_mingw_32_packages/
