...
cp -f ../opt-mingw-crt5/opt-mingw-i686-headers-git-5.0.0.4746.715ecca90d57-1-any.pkg.tar.zst ./gcc6.5.0_toolchain_mingw_32_packages/
cp -f ../opt-mingw-crt5/opt-mingw-i686-crt-git-5.0.0.4746.715ecca90d57-1-any.pkg.tar.zst ./gcc6.5.0_toolchain_mingw_32_packages/
cp -f ../opt-mingw-crt5/opt-mingw-i686-pthread-stub-headers-git-5.0.0.4746.715ecca90d57-1-any.pkg.tar.zst ./gcc6.5.0_toolchain_mingw_32_packages/
