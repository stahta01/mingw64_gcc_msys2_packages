...
cp -f ../opt-mingw-crt6/opt-mingw-x86_64-headers-git-6.0.0.5241.e174bf62d33d-2-any.pkg.tar.zst ./gcc6.5.0_toolchain_mingw_64_packages/
cp -f ../opt-mingw-crt6/opt-mingw-x86_64-crt-git-6.0.0.5241.e174bf62d33d-2-any.pkg.tar.zst ./gcc6.5.0_toolchain_mingw_64_packages/
...
cp -f ../opt-mingw-binutils2.27/opt-mingw-x86_64-binutils-git-2.27+r88001.c1.gb5d3ac25628b-2-any.pkg.tar.zst ./gcc6.5.0_toolchain_mingw_64_packages/
...
cp -f ../opt-mingw-crt6/opt-mingw-i686-headers-git-6.0.0.5241.e174bf62d33d-2-any.pkg.tar.zst ./gcc6.5.0_toolchain_mingw_32_packages/
cp -f ../opt-mingw-crt6/opt-mingw-i686-crt-git-6.0.0.5241.e174bf62d33d-2-any.pkg.tar.zst ./gcc6.5.0_toolchain_mingw_32_packages/
...
cp -f ../opt-mingw-binutils2.27/opt-mingw-i686-binutils-git-2.27+r88001.c1.gb5d3ac25628b-2-any.pkg.tar.zst ./gcc6.5.0_toolchain_mingw_32_packages/
