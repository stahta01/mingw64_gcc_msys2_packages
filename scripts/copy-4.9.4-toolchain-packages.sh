...
cp -f ../opt-mingw-crt6/opt-mingw-x86_64-headers-git-6.0.0.5241.e174bf62d33d-2-any.pkg.tar.zst ./gcc4.9.4_toolchain_mingw_64_packages/
cp -f ../opt-mingw-crt6/opt-mingw-x86_64-crt-git-6.0.0.5241.e174bf62d33d-2-any.pkg.tar.zst ./gcc4.9.4_toolchain_mingw_64_packages/
...
cp -f ../opt-mingw-binutils2.25/opt-mingw-x86_64-binutils-git-2.25+r82134.c5.g8f2db47d13b6-2-any.pkg.tar.zst ./gcc4.9.4_toolchain_mingw_64_packages/
...
cp -f ../opt-mingw-crt6/opt-mingw-i686-headers-git-6.0.0.5241.e174bf62d33d-2-any.pkg.tar.zst ./gcc4.9.4_toolchain_mingw_32_packages/
cp -f ../opt-mingw-crt6/opt-mingw-i686-crt-git-6.0.0.5241.e174bf62d33d-2-any.pkg.tar.zst ./gcc4.9.4_toolchain_mingw_32_packages/
...
cp -f ../opt-mingw-binutils2.25/opt-mingw-i686-binutils-git-2.25+r82134.c5.g8f2db47d13b6-2-any.pkg.tar.zst ./gcc4.9.4_toolchain_mingw_32_packages/
