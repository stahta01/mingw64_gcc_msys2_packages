...
cp -f ../opt-mingw-gcc4.7/opt-mingw-i686-gcc-libs-git-4.7.4+d20140612.r45.c9.g4d1f511d7f2f-5-any.pkg.tar.zst ./gcc4.7.4_toolchain_mingw_32_packages/
cp -f ../opt-mingw-gcc4.7/opt-mingw-i686-gcc-git-4.7.4+d20140612.r45.c9.g4d1f511d7f2f-5-any.pkg.tar.zst ./gcc4.7.4_toolchain_mingw_32_packages/
cp -f ../opt-mingw-gcc4.7/opt-mingw-i686-gcc-ada-git-4.7.4+d20140612.r45.c9.g4d1f511d7f2f-5-any.pkg.tar.zst ./gcc4.7.4_toolchain_mingw_32_packages/
