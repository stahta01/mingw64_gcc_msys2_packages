...
cp -f ../opt-mingw-crt2.0.9/opt-mingw-i686-headers-git-2.0.9.2715.ea32a0c5bf6f-1-any.pkg.tar.zst ./gcc4.6.4_toolchain_mingw_32_packages/
cp -f ../opt-mingw-crt2.0.9/opt-mingw-i686-crt-git-2.0.9.2715.ea32a0c5bf6f-1-any.pkg.tar.zst ./gcc4.6.4_toolchain_mingw_32_packages/
